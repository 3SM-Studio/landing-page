...
export function FeaturedWorkCard({ item, featuredLabel, featuredHint }: FeaturedWorkCardProps) {
  return (
    <Link
      href={{
        pathname: '/work/[slug]',
    ...
    >
      <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
        <div>
          <WorkMeta serviceLabel={item.primaryService?.title} year={item.year} size="hero" />

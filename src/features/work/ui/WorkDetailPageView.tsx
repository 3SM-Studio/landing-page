...
import type { WorkDetailCopy, WorkProject } from '../lib/work.types';
import { WorkBackground } from './WorkBackground';
import { WorkMeta } from './WorkMeta';
import { WorkPortableSection } from './WorkPortableSection';
      ...
      <Container className="relative z-10">
        ...
        <article className="mx-auto max-w-5xl">
          <header className="mb-12">
            <WorkMeta locale={locale} category={work.category} year={work.year} size="page" />

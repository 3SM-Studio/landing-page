...
import { projectTypeValues, type ContactFormInput } from '@/shared/contact-form.shared';
...
import { buildProjectOptions, normalizeContactPayload } from '../lib/contact.utils';
import type { ContactFormResponse, ContactFormStatus } from '../lib/contact.types';
